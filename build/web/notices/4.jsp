...
<!-- Mirrored from venus.t1m9m.com/notices/4 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:12 GMT -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div id="page-main">
                        ...
                        <div class="row">
                                ...
                                <div class="author">
                                    <blockquote>
                                        <article class="paragraph-wrapper">
                                            <div class="inner">
                                                <h3>The Reunion Giving Report 2016 </h3>
                                                <header>More than 700 alumni and friends celebrated BC Law Reunion and Alumni Weekend 2016 last November. The weekend provided alumni from across ten classes the chance to reconnect with classmates, professors, and our beloved alma mater. The weekend kicked off on Friday with events that included a panel hosted by the Rappaport Center for Law and Public Policy entitled “Terrorism: Current Threats and Possible Responses.”</header>
                                ...
                                <div class="author">
                                    <blockquote>
                                        <article class="paragraph-wrapper">
                                            <div class="inner">
                                                <h3>Scott Brown Named Ambassador </h3>
                                                <header>NEWSMAKER: Scott Brown ’85 was confirmed by the US Senate as ambassador to New Zealand on June 8. Nominated in April by President Trump, the former Massachusetts legislator, US Senator, and early Trump supporter won confirmation 94-4. NEWSMAKER: Scott Brown ’85 was confirmed by the US Senate as ambassador to New Zealand on June 8. Nominated in April by President Trump, the former Massachusetts legislator, US Senator.</header>
                                                <footer>10 Dec, 2018</footer>
                                            </div>
                                        </article>
                                    </blockquote>
                    ...
                    <div class="center">
                        <ul class="pagination">
                        <li><a href="../notices.html" data-ci-pagination-page="1" rel="prev">Previous </li><li></a><a href="../notices.html" data-ci-pagination-page="1" rel="start">1</a> </li><li><a class="active" style="color: #FFF">2</a> </li>                        </ul>
                    </div>
                </div><!-- /#page-main -->
            </div><!-- /.col-md-8 -->
        </div><!-- /.row -->
