...
<!-- Mirrored from venus.t1m9m.com/event/alumni-reunion-jan-2017 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:12 GMT -->
...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">MBA Alumni Reunion Weekend January</li>
    </ol>
</div>
<!-- end Breadcrumb -->
...
<div id="page-content">
    <div class="container">
                <header><h1>MBA Alumni Reunion Weekend January</h1></header>
        <div class="row">
            <!-- Course Image -->
            <div class="col-md-2 col-sm-3">
                <figure class="event-image">
                    <div class="image-wrapper">
                        <img src="../uploads/events/event-6.jpg">
                    </div>
                </figure>
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Friday October 25, 2019</h2>
                                </header>
                                <hr>
                                ...
                                <hr>
                                <figure>
                                    <span class="course-summary"><i class="fa fa-map-marker"></i> ESCP Europe Paris Campus ESCP</span>
                                    <span class="course-summary"><i class="fa fa-hashtag"></i>reunion-jan-19</span>
                                    <span class="course-summary"><i class="fa fa-clock-o"></i>11:15 PM</span>
                                </figure>
                            ...
                            <section id="course-info">
                                ...
                                <p>As you have experienced for yourself, INSEAD is a truly unique institution.  We graduate inspired individuals equipped with sound business knowledge and international wisdom.</p>
                                <p>This weekend, I look forward to sharing my plans with you and I want to hear your views.  Our Alumni Reunions team has worked hard and put together an incredible programme for you.  Besides the Plenary Session which will focus on the MBA programme and our Alumni network, our Faculty Forums will also cover important themes relevant to the business world of today.</p>
                                <p>Throughout the weekend’s Social and Networking events, your Reunion will provide you with the ideal opportunity to expand your horizons – a chance to, not only reconnect with your former classmates, but also to interact with Alumni of other classes that hold the same INSEAD spirit.</p>
                            </section>
                            ...
                            <section id="map">
                                ...
                                <div class="map-wrapper">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11225623.254045447!2d12.624510538060132!3d46.61430122358173!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66df03a0e68ef:0xefc13bfaf3e8fa70!2sESCP+Europe+Paris+Campus!5e0!3m2!1sen!2sbd!4v1504" width="100%" height="350" frameborder="0" style="border:0"></iframe>
                                </div>
                            </section><!-- /#map -->
