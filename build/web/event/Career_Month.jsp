...
<!-- Mirrored from venus.t1m9m.com/event/Career_Month by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:01 GMT -->
...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Career Month</li>
    </ol>
</div>
<!-- end Breadcrumb -->
...
<div id="page-content">
    <div class="container">
                <header><h1>Career Month</h1></header>
        <div class="row">
            <!-- Course Image -->
            <div class="col-md-2 col-sm-3">
                <figure class="event-image">
                    <div class="image-wrapper">
                        <img src="../uploads/events/event-3.jpg">
                    </div>
                </figure>
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Monday October 14, 2019</h2>
                                </header>
                                <hr>
                                ...
                                <hr>
                                <figure>
                                    <span class="course-summary"><i class="fa fa-map-marker"></i>University Ave Waukee, IA 50263 USA </span>
                                    <span class="course-summary"><i class="fa fa-hashtag"></i>career-month</span>
                            ...
                            <section id="course-info">
                                ...
                                <p>Take advantage of the UChicago alumni network to find a job, fill a position, or build your professional network.</p>
                                <p>Whether you are looking for a job or to hire fellow Maroons, interested in building your network or serving as a networking contact for others, Career Month offers a variety of career-focused events for UChicagoans around the country and abroad.</p>
                                <p>Career Month 2016 may be over, but you can always find helpful employment resources—including the Alumni Directory, recorded webinars, and the alumni jobs board—at Alumni Career Programs.</p>
                            </section>
                            ...
                            <section id="map">
                                ...
                                <div class="map-wrapper">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2983.5566443543094!2d-93.8457532486748!3d41.600473190618494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87ec20c016219af9:0xf65285711aebfb19!2sUniversity+Ave,+Waukee,+IA+50263,+USA!5e0!3" width="100%" height="350" frameborder="0" style="border:0"></iframe>
                                </div>
                            </section><!-- /#map -->
