...
<!-- Mirrored from venus.t1m9m.com/event/homecoming by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:01 GMT -->
...
<div id="page-content">
    <div class="container">
                <header><h1>Homecoming</h1></header>
        <div class="row">
            <!-- Course Image -->
            <div class="col-md-2 col-sm-3">
                <figure class="event-image">
                    <div class="image-wrapper">
                        <img src="../uploads/events/event-2.jpg">
                    </div>
                </figure>
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Thursday July 25, 2019</h2>
                                </header>
                                <hr>
                                ...
                                <hr>
                                <figure>
                                    <span class="course-summary"><i class="fa fa-map-marker"></i>MIT, Massachusetts Avenue, Cambridge, MA, United States</span>
                                    <span class="course-summary"><i class="fa fa-hashtag"></i>homecoming'17</span>
                                    <span class="course-summary"><i class="fa fa-clock-o"></i>11:30 PM</span>
                                </figure>
                            ...
                            <section id="course-info">
                                ...
                                <p>This year’s Phoenixphest theme is game night! September 14–21, Maroons worldwide will come together to enjoy food and drinks while meeting new people and connecting with former classmates.</p>
                                <p>An old tradition given new life in recent years, Homecoming is an opportunity to reconnect with old friends, cheer on the Maroons, and remember that rigor and discipline can extend beyond academia.</p>
                                <p>Phoenixphest is your chance to rekindle old friendships, make new connections, engage in enriching conversation, and welcome UChicago’s newest graduates into the local—and global—alumni community.</p>
                            </section>
                            ...
                            <section id="map">
                                ...
                                <div class="map-wrapper">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2948.175688404907!2d-71.09635404865833!3d42.3600949429892!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e370aaf51a6a87:0xd0e08ea5b308203c!2sMassachusetts+Institute+of+Technology!5e0!3m2!1sen!" width="100%" height="350" frameborder="0" style="border:0"></iframe>
                                </div>
                            </section><!-- /#map -->
