...
<!-- Mirrored from venus.t1m9m.com/event/Alumni_Weekend by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:01 GMT -->
...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Alumni Weekend</li>
    </ol>
</div>
<!-- end Breadcrumb -->
...
<div id="page-content">
    <div class="container">
                <header><h1>Alumni Weekend</h1></header>
        <div class="row">
            <!-- Course Image -->
            <div class="col-md-2 col-sm-3">
                <figure class="event-image">
                    <div class="image-wrapper">
                        <img src="../uploads/events/event-4.jpg">
                    </div>
                </figure>
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Thursday March 12, 2020</h2>
                                </header>
                                <hr>
                                ...
                                <hr>
                                <figure>
                                    <span class="course-summary"><i class="fa fa-map-marker"></i>University of Toronto, Mississauga, ON, Canada</span>
                                    <span class="course-summary"><i class="fa fa-hashtag"></i>weekend09</span>
                                    <span class="course-summary"><i class="fa fa-clock-o"></i>12:30 PM</span>
                                </figure>
                            ...
                            <section id="course-info">
                                ...
                                <p>An item from the alumni weekend scavenger hunt. Write-up of the hunt, including the list, will be up on Facebook tomorrow. #uchiaw @uchicagoalumni #alumniscav</p>
                            ...
                            <section id="map">
                                ...
                                <div class="map-wrapper">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2891.8161494082833!2d-79.6657054486318!3d43.5478741671502!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b43e3727abc63:0x3781d77e01557d19!2sUniversity+of+Toronto!5e0!3m2!1sen!2sbd!4v150468040" width="100%" height="350" frameborder="0" style="border:0"></iframe>
                                </div>
                            </section><!-- /#map -->
