...
<!-- Mirrored from venus.t1m9m.com/archive_stories/1 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 17:26:03 GMT -->
...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Archive Stories</li>
    </ol>
</div>
<!-- end Breadcrumb -->
            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section class="blog-listing" id="blog-listing">
                        <header><h1>Archive Stories</h1></header>
                        <div class="row">
                                ...
                                <article class="blog-listing-post">
                                    <figure class="blog-thumbnail">
                                        ...
                                        <div class="image-wrapper">
                                            <a href="../story/coming-full-circle.html">
                                                <img src="../uploads/stories/story-1.jpg">
                                            </a>
                                        </div>
                                    </figure>
                                    <aside>
                                        <header>
                                            <a href="../story/coming-full-circle.html">
                                                <h3>A journey to journalism: coming full circle</h3>
                                            </a>
                                        </header>
                                    </aside>
                                </article><!-- /article -->
                                ...
                                <article class="blog-listing-post">
                                    <figure class="blog-thumbnail">
                                        <figure class="blog-meta">
                                            ...
                                            12-10-2018                                        </figure>
                                        <div class="image-wrapper">
                                            <a href="../story/power-of-camaraderie.html">
                                    ...
                                    <aside>
                                        <header>
                                            <a href="../story/power-of-camaraderie.html">
                                                <h3>The joy and power of camaraderie</h3>
                                            </a>
                                        </header>
                                    </aside>
                                </article><!-- /article -->
                                ...
                                <article class="blog-listing-post">
                                    <figure class="blog-thumbnail">
                                        <figure class="blog-meta">
                                            ...
                                            12-10-2018                                        </figure>
                                        <div class="image-wrapper">
                                            <a href="../story/solutions-to-air-pollution.html">
                                                <img src="../uploads/stories/story-3.jpg">
                                            </a>
                                        </div>
                                    </figure>
                                    <aside>
                                        <header>
                                            <a href="../story/solutions-to-air-pollution.html">
                                                <h3>Harder to breathe: finding solutions to air pollution</h3>
                                            </a>
                                        </header>
                                    </aside>
                                </article><!-- /article -->
                                    ...
                                    <figure class="blog-thumbnail">
                                        ...
                                        <div class="image-wrapper">
                                            <a href="../story/star-_nomadess.html">
                                                <img src="../uploads/stories/story-4.jpg">
                                            </a>
                                        </div>
                                    </figure>
                                    <aside>
                                        <header>
                                            <a href="../story/star-_nomadess.html">
                                                <h3>A journey under the star of the nomadess</h3>
                                            </a>
                                        </header>
                                    </aside>
                                </article><!-- /article -->
                                    ...
                                    <figure class="blog-thumbnail">
                                        ...
                                        <div class="image-wrapper">
                                            <a href="../story/magic-cambridge.html">
                                                <img src="../uploads/stories/story-6.jpg">
                                            </a>
                                        </div>
                                    </figure>
                                    <aside>
                                        <header>
                                            <a href="../story/magic-cambridge.html">
                                                <h3>The life changing magic of Cambridge</h3>
                                            </a>
                                        </header>
                                    </aside>
                                </article><!-- /article -->
