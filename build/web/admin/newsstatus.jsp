...
<%
    ...
    String sql = "update tbl_news set status = '1' where id = '" + accept_id + "'";
...
<%
    ...
    String sql2 = "update tbl_news set status = '0' where id = '" + reject_id + "'";

    int i2 = st2.executeUpdate(sql2);
    
    if(i2 > 0){ %>
                <script type="text/javascript">
                    alert("News Un-published Successfully !");
                    window.location = "allnews.jsp";
                </script>
<%
            } 
