<%-- 
    Document   : pending
    Created on : Jul 20, 2019, 11:32:58 PM
    Author     : singdho
--%>
...
<section class="content">
        ...
        <tr>
                                ...
                                <ul class="dropdown-menu">                                                                      
                                    ...
                                    <li><a class="dropdown-item" onclick="return confirm('Are You Sure To Approve the user ?')" href="approve.jsp?id=<%= uni_id %>">Approve</a>
                                    </li>
