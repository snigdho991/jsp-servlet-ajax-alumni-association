...
public class newsImage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("update tbl_news set file = ? where id = ?");
            pst.setString(1, dbFileName);
            pst.setString(2, id);
         
            pst.executeUpdate();
            out.println("<script language=\"Javascript\">"); 
            out.println("alert(\"News Image Uploaded Successfully !\");"); 
            out.println("window.location = \"admin/allnews.jsp\";"); 
            out.println("</script>");
